...
enum ExprType {
    CONST_EXPR, STR_EXPR, ID_EXPR, UNOP_EXPR, BINOP_EXPR, RELOP_EXPR, LAMBDA_EXPR, FUNC_EXPR
};

enum StmtType {
    PRINT_STMT, EXPR_STMT, LET_STMT, ASSIGN_STMT, WHILE_STMT, IF_STMT, RETURN_STMT
};

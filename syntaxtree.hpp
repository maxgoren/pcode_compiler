...
enum ExprType {
    CONST_EXPR, STR_EXPR, ID_EXPR, UNOP_EXPR, BINOP_EXPR, RELOP_EXPR, LAMBDA_EXPR, FUNC_EXPR, SUBSCRIPT_EXPR, ASSIGN_EXPR
};

enum StmtType {
    PRINT_STMT, EXPR_STMT, LET_STMT, WHILE_STMT, IF_STMT, RETURN_STMT
};
